...
cp src/dls76.x src/spgr.dat $dls_dir
...
set progn = $0
set progn = $progn:t' > dls76.csh

echo "set DLSDIR = ../$dls_dir" >> dls76.csh

echo 'set DLSX = $DLSDIR/dls76.x
...
unlink dls76
ln -s $base/$dls_dir/dls76.csh dls76
